 <?php
	...
	$onecolumn; 
	 if($num == 2){
		 $part1=$books->find_by_uploader($conditions[1]);
		 $part2=$sbooks->find_by_uploader($conditions[1]);
		if($part1){
...
<div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-md-8" style="border: #EFEDED solid 3px;padding-top:20px;border-radius:10px">
                ...
                <div class="row">
                	...
                	<div class="col-md-5">
                     <table>
                        ...
                        <tr><th><small>By :<?php echo $oneset->uploader;?></small><hr/></th></tr>
