...
<?php
	if(isset($_POST['cancel'])){
		$order->cancel($_POST['order-id']);
		redirect_to("beminder_user_order.php");
	}
 	if($session->is_logged_in()){
        ...
        <div class="row"><div class="col-md-12"><a type="button" class="btn btn-primary" href="usercart.php">Back To cart</a></div></div>
             <h3>Your Orders  </h3> 
			<div class="row" style="padding:10px 0px">	
            <div class="col-md-9" style="padding: 10px 20px 10px 30px;">
            <table border="1">
              <tr><th>Order Id</th><th>Book Name</th><th>Quantity</th><th>Price</th><th>Status</th><th>Servic as</th><th>From</th><th>date/time</th><th>cancel order</th></tr>
        <?php
		foreach($all_orders as $order){
			...
			echo '<tr>
					...
					<th>
					<form action="beminder_user_order.php" method="post">
		...
		?>	</table>
            ...
            <div class="col-md-3">
                ...
                <p><a type="button" class="btn btn-primary myMenu" href="beminder_user_order.php"><span class="glyphicon glyphicon-chevron-left"></span>Your Orders</a></p>
